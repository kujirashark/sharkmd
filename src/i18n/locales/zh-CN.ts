...
const zhCN = {
  ...
  update: {
    ...
    openRelease: '前往下载',
    upToDate: '当前已是最新版本',
    upToDateHint: '你用的是最新版本，无需更新',
    newerTitle: '有新版本可用',
    checking: '正在检查...',
    checkingHint: '正在连接 GitHub Releases...',
    releaseNotes: '更新说明',
    browseReleases: '查看所有发布',
    retry: '重试',
    close: '关闭',
    error: {
      title: '检查更新失败',
      ...
      apiHint: '这通常表示仓库没有已发布的版本（draft 状态不会出现在 /releases/latest）。点击下方「查看所有发布」可直接打开 GitHub 页面。',
      networkHint: '请检查网络连接后点击「重试」。你也可以直接打开 GitHub releases 页查看。',
    },
  },
};
